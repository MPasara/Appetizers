...
struct AlertContext {
    ...
    //MARK: - Account Alerts
    static let formNotValid = AlertItem(
        title: Text("Form is not valid"),
        message:
            Text(
                "Please ensure all fields in the form have been filled out."
            ),
        dismissButton: .default(Text("OK")))
    ...
    static let invalidUserData = AlertItem(
        ...
        message:
            Text(
                "There was and error saving or retriving your profile."
            ),
        dismissButton: .default(Text("OK")))
}
